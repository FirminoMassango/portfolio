...
export default function Home() {
  return (
    <main className={`min-h-screen p-28 ${montserrat.className}`}>
      <section>
        <div className="lg:flex justify-between">
          <div className="">
            <h1 className={`text-white text-9xl ${zenDots.className}`}>
              Firmino
              <br /> Massango
            </h1>
          </div>
          <div className="">
            <span className="lg:absolute top-16 right-28 mx-auto pt-32 text-5xl font-bold bg-gradient-to-r from-zinc-800 to-zinc-500 bg-clip-text text-transparent">
              A UX Developer
            </span>
          </div>
        </div>
        <div className="flex justify-between">
          <div>
            <p className="w-2/3 text-white text-2xl mt-12">
              I am a{" "}
              <span className="font-semibold pr-2">Software Engineer</span>
              and
              <span className="font-semibold pl-2">UX Designer</span>. I love
              building better experiences for clients / users.
            </p>
            <button className="flex items-center text-white border-2 border-white p-4 rounded mt-16 font-medium">
