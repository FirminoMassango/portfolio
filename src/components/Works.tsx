...
function Works(props: FontProps) {
  return (
    <section className="h-screen snap-start mb-16 pt-8">
      ...
      <div className="flex">
        <div className="flex flex-col flex-1 items-start justify-between mr-8">
          <span className="text-xl font-semibold bg-zinc-800 py-2 px-4 rounded">
            Software Development
          </span>
          <span className="text-white/50 text-xl font-semibold py-2 px-4 mt-16">
            UI/UX
          </span>
          <svg
            width="100"
          ...
          <a href="#" className="font-semibold underline decoration-sky-500">
            Contact Me
          </a>
        </div>
